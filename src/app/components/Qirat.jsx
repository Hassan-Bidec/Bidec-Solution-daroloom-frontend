...
export default function Qirat() {
  ...
  const card = [
    {
      number : 2029,
      hadith : "المصادر المستنْدمة"
    },
   
    {
      number : 1020,
      hadith : "عدد الأحاديث المرفوعة"
    },
    {
      number : 7414,
      hadith : "الموضوعات والعناوين"
    },
  ]
  ...
  return (
    <>
      <div className="md:mt-60">
        ...
        <div className="hidden md:flex justify-center items-center text-center gap-10 mb-16 relative">
          ...
          {/* Box 2 */}
          <div className="relative flex flex-col items-center">
            <div className="border-2 border-teal-700 rounded-xl p-6 w-52 h-32 bg-white shadow-sm flex flex-col justify-center">
              <div className="text-2xl font-semibold text-teal-700">11451</div>
              <div className="text-gray-700 mt-1">{t("عدد طرق الأحاديث")}</div>
            </div>
            <div className="absolute top-1/2 right-[-40px] w-10 h-[2px] bg-teal-700"></div>
          </div>

          {
            ...
            <div className="border-2 border-teal-700 rounded-xl p-6 w-52 h-32 bg-white shadow-sm flex flex-col justify-center">
              <div className="text-2xl font-semibold text-teal-700">{i.number}</div>
              <div className="text-gray-700 mt-1">{t(`${i.hadith}`)}</div>
            </div>
            <div className="absolute top-1/2 right-[-40px] w-10 h-[2px] bg-teal-700"></div>
          </div>
            ))
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 px-6 rtl text-right mt-16">
